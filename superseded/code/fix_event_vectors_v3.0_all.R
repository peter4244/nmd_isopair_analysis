#!/usr/bin/env Rscript
# Fix Event Vectors v3.0 ALL - Remove Invalid Event Classifications
...
cat("\n")
cat("╔════════════════════════════════════════════════════════════════╗\n")
cat("║   FIX EVENT VECTORS v3.0 ALL - Remove Invalid Classifications ║\n")
cat("╚════════════════════════════════════════════════════════════════╝\n")
cat("\n")

# Configuration
input_file <- "results/isoform_transitions/v3.0_reference_based/reference_event_vectors_v3.0_all.rds"
output_file <- "results/isoform_transitions/v3.0_reference_based/reference_event_vectors_v3.0_all_FIXED.rds"

# Load data
cat("Loading v3.0 ALL event vectors...\n")
