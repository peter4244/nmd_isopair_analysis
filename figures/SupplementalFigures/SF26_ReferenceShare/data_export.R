#!/usr/bin/env Rscript
# SF26 — Reference-isoform share of gene expression (post 25% reference-share floor).
#
...
#
# Output (SF26_ReferenceShare/data/):
...
cat(sprintf("SF26: n=%d genes  median=%.1f%%  >=50%%: %.1f%%  (floor 25%%, all-iso, all_samples DMSO)\n",
