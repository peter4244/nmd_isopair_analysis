...
def render_kozak_violin(ax, tsv_name, pvalue_text):
    ...
    # Directional-comparison count moved to the legend (see SF33).
...
def main():
    ...
    out = HERE.parent
    fig.savefig(out / "figure_sf34.pdf", facecolor="white")
    fig.savefig(out / "figure_sf34.png", dpi=300, facecolor="white")
