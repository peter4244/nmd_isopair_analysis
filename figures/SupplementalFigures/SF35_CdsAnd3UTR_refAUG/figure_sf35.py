...
def render_panel(ax, long, desc, stats, value_col, ylabel):
    ...
    # project_nmd_sf32_sf35_companion memory.
    ...
    # Tilted 30° 2-row labels at BODY_FS-4 — matches SF32 companion.
    ax.set_xticklabels(
...
def build_figure():
    # 2×2 layout with Panel C bottom-center — matches SF32 companion.
...
def main():
    ...
    out = HERE.parent
    fig.savefig(out / "figure_sf35.pdf", facecolor="white")
    fig.savefig(out / "figure_sf35.png", dpi=300, facecolor="white")
    print("Saved: figure_sf35.{pdf,png}")
