#!/usr/bin/env Rscript
# SF25 — expressed non-NMD isoform count per pop_BC gene (post 25% floor).
#
...
#
# Output (SF25_IsoformsPerGene/data/): isoforms_per_gene.tsv (gene_id, n_isoforms),
...
cat(sprintf("SF25: %d genes  median=%d isoforms/gene  IQR=%d\n",
