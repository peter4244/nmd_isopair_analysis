#!/usr/bin/env Rscript
# SF29 — GAIN/LOSS direction by splice-event type, NMD vs Control (post 25% floor).
#
...
#
# Output (SF29_GainDirectionByEvent/data/): table1c_gain_loss_events.csv.
...
cat(sprintf("SF29: %d event types over %d NMD / %d Control pop_BC pairs\n",
