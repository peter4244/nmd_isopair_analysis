...
- [ ] **Significance stars must be defined** whenever used: e.g. `*p < 0.05, **p < 10⁻³, ***p < 10⁻⁴; n.s. otherwise`. A legend that says "significance stars" or shows `*/**/***` without the key is incomplete. (SF29 recurred.)
