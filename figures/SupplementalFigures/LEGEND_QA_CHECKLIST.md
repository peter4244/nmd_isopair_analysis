...
- [ ] Panel-by-panel (A/B/C…) coverage; every panel referenced; line/marker keys defined (dashed = median, etc.) and **matching what the figure actually draws** — SF27 legend named a "dotted 50% line" the figure no longer had.
