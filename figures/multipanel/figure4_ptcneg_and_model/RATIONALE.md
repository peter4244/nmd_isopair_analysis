...
The TD2-bias justification panels (which previously occupied Section B of the main figure) now live in `figures/SupplementalFigures/TD2BiasEvidence/` and present three orthogonal observations at two complementary scopes (2×3 layout):
