...
- **Figure work: open `the `figures` skill (~/.claude/skills/figures/SKILL.md)` FIRST** for any figure task (new panel, edit, legend, mockup). It sequences the universal workflow. Publications runbook: `figures_workflow_publications.md`.
