#!/bin/bash
#SBATCH --job-name=test_mm2_10_10
#SBATCH --output=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_10_10.slurm.out
#SBATCH --error=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_10_10.slurm.err
#SBATCH --mem=80G
...
# ============================================================================
# MINIMAP2 THREAD OPTIMIZATION TEST - Configuration 10/10 (BALANCED)
# ============================================================================
# Thread allocation: 10 minimap2 threads + 10 samtools threads (balanced)
...
OUTPUT_BAM="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_10_10.bam"
LOG_FILE="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_10_10.log"
