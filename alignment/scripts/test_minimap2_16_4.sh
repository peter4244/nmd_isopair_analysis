#!/bin/bash
#SBATCH --job-name=test_mm2_16_4
#SBATCH --output=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_16_4.slurm.out
#SBATCH --error=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_16_4.slurm.err
#SBATCH --mem=80G
...
# ============================================================================
# MINIMAP2 THREAD OPTIMIZATION TEST - Configuration 16/4
# ============================================================================
# Thread allocation: 16 minimap2 threads + 4 samtools threads
...
OUTPUT_BAM="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_16_4.bam"
LOG_FILE="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_16_4.log"
