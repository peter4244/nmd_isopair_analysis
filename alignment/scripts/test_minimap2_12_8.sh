#!/bin/bash
#SBATCH --job-name=test_mm2_12_8
#SBATCH --output=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_12_8.slurm.out
#SBATCH --error=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_12_8.slurm.err
#SBATCH --mem=80G
...
# ============================================================================
# MINIMAP2 THREAD OPTIMIZATION TEST - Configuration 12/8
# ============================================================================
# Thread allocation: 12 minimap2 threads + 8 samtools threads
...
OUTPUT_BAM="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_12_8.bam"
LOG_FILE="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_12_8.log"
