#!/bin/bash
#SBATCH --job-name=test_mm2_18_2
#SBATCH --output=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_18_2.slurm.out
#SBATCH --error=/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_18_2.slurm.err
#SBATCH --mem=80G
...
# ============================================================================
# MINIMAP2 THREAD OPTIMIZATION TEST - Configuration 18/2
# ============================================================================
# Thread allocation: 18 minimap2 threads + 2 samtools threads
...
OUTPUT_BAM="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_18_2.bam"
LOG_FILE="/proj/regeps/regep00/studies/ExternalCellLines/analyses/repjc/Randell_Lung_Cells_2025/results/oarfish/gencode49_merd_collapse2025.12.21/test_alignment_18_2.log"

# Temp directory on shared filesystem (avoids SLURM temp management)
# Use SLURM_JOB_ID if set, otherwise use process ID
